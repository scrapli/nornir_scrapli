...
TEST_SCRAPLI_RESPONSE_ONE.record_response(result=IOSXE_SHOW_VERSION)
TEST_SCRAPLI_RESPONSE_TWO = Response(
    host="sea-ios-1", channel_input="show ip route", textfsm_platform="cisco_iosxe"
)
TEST_SCRAPLI_RESPONSE_TWO.record_response(result=IOSXE_SHOW_IP_ROUTE)
...
def test_print_structured_result(capsys):
    print_structured_result(TEST_AGG_RESULT)
